...
public class PlayMoveMentControll : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        transform.localPosition = Vector2.ClampMagnitude(eventData.position - (Vector2)joystick.position, joystick.rect.width * 0.5f);
        ...
        {
            walking = true;
            arObject.GetComponent<Animator>().SetBool("Roll_Anim", true); // on drag walk animation
        }
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        walking = false;
        arObject.GetComponent<Animator>().SetBool("Roll_Anim", false);
